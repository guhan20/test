...
API_ID = int(environ['2032193'])
API_HASH = environ['8e06818e6ca64ab674031280c063b2e1']
BOT_TOKEN = environ['5208722762:AAGQmIy-WhZrFJNOj068GwPXf_kYKSNanxk']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1291364201').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001769102299 -1001329116889').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gtberno:gtnero@cluster0.1q59rw1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Rajappan")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('-1001655120387', 0))
...
RP_CHANNEL = int(environ.get('RP_CHANNEL', "-1001527001672"))
